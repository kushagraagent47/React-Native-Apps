...
import { StyleSheet, Text, View, ScrollView, TouchableOpacity, Linking, Platform, AsyncStorage, Alert } from 'react-native';
// ReactNative
...
export default class ViewContactScreen extends React.Component {
    ...
    callAction = phone => {
        ...
        Linking.canOpenURL(phoneNumber)
            .then(supported => {
                if (!supported) {
                    Alert.alert("Phone number is not avalaible")
                }
                else {
