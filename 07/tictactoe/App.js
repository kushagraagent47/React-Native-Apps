...
export default class App extends React.Component {
  ...
  winGame = () => {
    if ((itemArray[0] !== "empty") && (itemArray[0] == itemArray[1]) && (itemArray[1] == itemArray[2])) {
      ...
      Alert.alert((itemArray[0] ? 'cross' : "circle").concat(' wins'))
      this.resetGame();
    }
      ...
      Alert.alert((itemArray[3] ? 'cross' : "circle").concat(' wins'))
      this.resetGame();
    }
      ...
      Alert.alert((itemArray[6] ? 'cross' : "circle").concat(' wins'))
      this.resetGame();
    }
      ...
      Alert.alert((itemArray[1] ? 'cross' : "circle").concat(' wins'))
      this.resetGame();
    }
      ...
      Alert.alert((itemArray[2] ? 'cross' : "circle").concat(' wins'))
      this.resetGame();
    }
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        >
          <Text style={styles.btnText}>ResetGame</Text>
        </Button>
      </View>
    );
  }
